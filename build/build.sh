...
C_INCLUDE_PATH="${OPUS_INCLUDE_PATH}:${WHISPER_INCLUDE_PATH}:${ONNX_INCLUDE_PATH}:${AZURE_SDK_INCLUDE_PATH}:${NEMO_INCLUDE_PATH}" \
LIBRARY_PATH="${OPUS_LIBRARY_PATH}:${WHISPER_LIBRARY_PATH}:${ONNX_LIBRARY_PATH}:${AZURE_SDK_LIBRARY_PATH}:${NEMO_LIBRARY_PATH}" \
